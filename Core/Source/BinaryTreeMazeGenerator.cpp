...
namespace Core {
BinaryTreeMazeGenerator::BinaryTreeMazeGenerator() noexcept: MazeGenerator {"BinaryTree"} {

}

void BinaryTreeMazeGenerator::generate(Core::Grid* const grid, const std::optional<unsigned long long>& seed) noexcept {
